    ...
    <section className="section-y site-section-alt">
      <div className="container-brand">
        <div className="grid md:grid-cols-2 gap-6">
          {/* Agent */}
          <div className="relative site-card rounded-2xl p-8 overflow-hidden group transition-all duration-300">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                <h3 className="font-display font-bold text-2xl site-heading">Become an agent</h3>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 site-accent font-semibold text-sm transition-colors group/link"
              >
                Apply now
          ...
          <div className="relative site-card rounded-2xl p-8 overflow-hidden group transition-all duration-300">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                <h3 className="font-display font-bold text-2xl site-heading">Become an affiliate</h3>
                <p className="text-white/50 text-sm mt-2 leading-relaxed site-text-muted">
        ...
        <div className="mt-14 rounded-2xl bg-gradient-to-r from-brand-citrus via-brand-mango to-brand-ember p-px">
          <div className="rounded-[15px] site-card px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
