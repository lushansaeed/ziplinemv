...
export default function CommissionManagementPage() {
  return (
    <DashboardShell title="Commission management" subtitle="View, approve, adjust, reject, mark paid, and export agent and affiliate commissions." nav={["Agents", "Affiliates", "Eligible", "Approved", "Paid", "Export"]}>
