...
export default function PricingManagementPage() {
  return (
    <DashboardShell title="Pricing management" subtitle="Edit default prices, seasonal offers, group rates, agent rates, affiliate rules, exchange rate, add-ons, and slot capacity." nav={["Default", "Seasonal", "Offers", "Group rates", "Agent rates"]}>
